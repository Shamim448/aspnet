...
![image]()
* আমাদেরকে ইনাস্টেন্স টাইম টি টু সিলেট করতে হবে কারণ এটা ফ্রি, ড্রপ ডাউন এ ক্লিক করলে আমরা নেক টাইপ দেখতে পারব যেখানে আমার প্রসেসর র‍্যাম এগুলো কি হতে পারে সেগুলো দেওয়া থাকবে এই ইন্সটেন্স টাইপের মধ্যে
![image]()
...
![image]()
![image]()
* এখানে সোর্স টাইপ এনি হওয়ার দেওয়া আছে যাতে করে আমরা যে কোন জায়গা থেকে যেকোনো আইপি থেকে এক্সেস করতে পারি আমরা ইচ্ছে করলে এখানে কোন একটা আইপি এড্রেস সাইন করে দিতে পারি তাহলে সেই আইপি বাদে অন্য কোথাও থেকে লগইন করা যাবে না,  এবং এখানে আমরা কাস্টম উল্টো সেট করে দিতে পারি আমরা সার্ভারকে ফোন থেকে এক্সেস করব
![image]()
...
![image]()
* আমাদের সার্ভার কে কানেক্ট করার জন্য ইন্সটেন্স সিলেক্ট করে কানেক্ট ভাবে ক্লিক করতে হবে তারপর আরডিপি ক্লাইন্ট সিলেক্ট করে  নিচে গিয়ে গেট পাসওয়ার্ড ক্লিক করতে হবে
![image]()
![image]()
* এখানে আমাদের সিক্রেট যে ফাইলটা ssskey কি যেটা আমরা ডাউনলোড করেছিলাম সেটা আপলোড করতে হবে এবং ডিক্রিপ্ট বাটনে চাপ দিতে হবে.
![image]()
...
![image]()
* ইনস্টেন্স করার জন্য ক্লিক করে আমার যে মেশিনটা আছে সেই মেশিনটা সিলেট করতে হবে তারপর উপর থেকে ইন্সটেন্সটেটে গিয়ে টার্গেট ইন্সটেন্স ক্লিক করতে হবে তাহলে আমারটা ডিলিট হয়ে যাবে তার আগে অবশ্যই রিমোট ডেস্কটপ দিয়ে যে আমার লগইন করেছি সেখানে পিসি তাকে ডিসকানেক্ট করে দিয়ে আসতে হবে 
![image]()
* Instance করার পরও ভলিউম এগিয়ে চেক করে দেখতে হবে যে আমার ভলিউম ডিলিট হয়েছে কিনা কারণ অনেক সময় ইনস্ট্যান্ট টা মিনিট করার পরও ভলিউম থেকে যায় সে ক্ষেত্রে চার্জ কাটতে পারে 
![image]()
